 ...
 */
public class TutorialsTable {
    private static final Logger logger = Logger.getLogger(TutorialsTable.class.getSimpleName());

    public static final String TABLE_NAME = "tbl_tutorials";
